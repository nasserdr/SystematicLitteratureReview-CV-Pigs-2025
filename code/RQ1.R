...
print(combined_plot)
ggsave(file.path(im_path, "biomarker_application_subapplication_histograms.png"),
...
ggsave(file.path(im_path, "alluvial_biomarker_application_subapplication.png"),
       p_alluvial, width = 50, height = 50, dpi = 400, limitsize = FALSE)
ggsave(file.path(im_path,"alluvial_biomarker_application_subapplication.pdf"),
