...
# 
# ggsave(
#   filename = file.path(im_path, "behavior_distribution_by_studytype_horizontal.png"),
#   plot = p,
...
ggsave(file.path(im_path,"alluvial_behavior_to_biomarker.png"),
       p_alluvial_behav_biom, width = 20, height = 14, dpi = 300, limitsize = FALSE)
ggsave(file.path(im_path,"alluvial_behavior_to_biomarker.pdf"),
       p_alluvial_behav_biom, width = 20, height = 14, limitsize = FALSE)
...
ggsave(file.path(im_path,"alluvial_behavior_to_application.png"),
...
ggsave(file.path(im_path,"alluvial_behavior_to_application.pdf"),
       p_alluvial_behav_app, width = 20, height = 14, limitsize = FALSE)
...
ggsave(file.path(im_path,"alluvial_category_to_application.png"),
       p_alluvial_cat_app, width = 20, height = 14, dpi = 300, limitsize = FALSE)
ggsave(file.path(im_path,"alluvial_category_to_application.pdf"),
       p_alluvial_cat_app, width = 20, height = 14, limitsize = FALSE)
