...
\begin{figure*}
    ...
    \includegraphics[width=\textwidth]{fig/cv_examples_classification}
...
\begin{figure*}
    \centering
    % Example schematic CV tasks overview
    \includegraphics[width=\textwidth]{fig/cv_examples_detection}
...
\begin{figure*}
    \centering
    % Example schematic CV tasks overview
    \includegraphics[width=\textwidth]{fig/cv_examples_action}
...
%     \centering
%     % Example schematic CV tasks overview
%     \includegraphics[width=\textwidth]{fig/cv_examples_anomaly_detection}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/prisma_diagram.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/critical_appraisal_distribution}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/journal_distribution_gt3}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/author_appearances_top25}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/animal_distribution}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/biomarker_vs_application_heatmap}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/cv_tasks_distribution}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/models_family_distribution}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/downstream_cvtask_stacked_bar}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/cnn_vs_transformer_share_by_year}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/metric_usage_barplot}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/performance_metrics_boxplots_sorted_by_range}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/challenges_distribution}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/behavior_full_figure}
    \caption{Distribution of behaviors (e.g., postural, feeding, aggressive) and associated methods and applications across the reviewed studies. \fix{HASSAN: optimize the plot.}}
    \label{fig:behavior_distribution}
\end{figure*}

Figure  ~\ref{fig:behavior_application_alluvial} further maps the behavior categories to their respective applications, revealing opportunities to extend CV-based monitoring into more complex social and health-related behaviors.

\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/alluvial_behavior_to_application}
    \caption{Alluvial diagram mapping behavior categories to their application domains in PLF for pigs. \fix{HASSAN: Optimize the plot.}}
    \label{fig:behavior_application_alluvial}
\end{figure*}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/methods_vs_applications_per_year}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/journal_distribution_top3_by_type}
    \caption{Comparison of method- versus application-focused papers across the top three journals. \fix{HASSAN: Optimize the plot}}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/annotation_software_hist}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/dataset_code_both_availability_share}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/image_resolutions_rectangles_centered}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fig/num_labeled_images_hist_linear}
